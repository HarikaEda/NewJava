...
try {
    ...
    }else System.out.println("geçerli bir pasword");
   throw new IllegalArgumentException("Nahsıl pasword girmek o...");
} catch (IllegalArgumentException e) {

    System.out.println("pasword uzunluğu 6-10 karakter arasında olmalıdır");

}
        System.out.println("App. başarılı");
