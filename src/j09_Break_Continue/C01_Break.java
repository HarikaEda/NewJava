 ...
 */
//task:girilen mail hesabında @ karakterine kadar olan karakterliri print eden code create ediniz...
        Scanner input=new Scanner(System.in);
        System.out.println("mail adresinizi giriniz");
        String mail= input.nextLine();
        for (int i=0;i<mail.length();i++){//ilk ve son karakter arası tekrarsartı
            if( mail.charAt(i)=='@')
                break;
