...
/* TASK :
       ...
       */
       /* Scanner input=new Scanner(System.in);
        ...
        System.out.println(input.nextLine().substring(0,input.nextLine().indexOf(" ")));+ //boşlugun indeksi
        System.out.println(input.nextLine().substring(input.nextLine().indexOf(" ") + 1));
* TASK :
        Kullanıcıdan tek seferde alınan ad soyadı ifadeyi
