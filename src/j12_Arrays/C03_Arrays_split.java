...
public class C03_Arrays_split {
    ...
    //String data Array' e cevirmek için ..split()->girilen parametre değere göre string parçalanır
    String str="javaCan'lara selam olsun";
    String arr[]=str.split("");//str hiçliğe göre parçalanıp her bir parça arr e atandı
