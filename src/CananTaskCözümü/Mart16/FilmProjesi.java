    ...
    /*
     TASK :
      ...
      kullanıcının kaybedip veya kazandığını ve tahmin etmesi gereken filmin ismini  console yazdırınız.
        ...
        1. adım:
        kullanıcıya film listesinden bir film seçtir.
        ...
        3. adım:
        harfleri "-" ile değiştir ve yazdır,
        filmin kaç harfli olduğunu yazdır.
        "JOKER" seçildiyse "-----" olarak gözüksün

        4. adım:
        filmdeki harf sayısına göre tahmin hakkı verilir.
        5 harfli film için 5 * 2 yani 10 tahmin hakkı

        5. adım:
        yanlış tahmin sayısını say

        6. adım:
        film için tahmin edilen harf al

        7. adım:
        harf filmin içinde bulunmuyorsa yanlış
        tahmin sayısını bir artır,
        bulunuyorsa harfin yerini göster

        8. adım:
        kazandınız veya kaybettiniz yazdır*/
