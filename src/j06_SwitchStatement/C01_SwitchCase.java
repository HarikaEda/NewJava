 ...
 */
        ...
        System.out.println("Dadas hele bir sayı gir :");
...
//if cözümü
       /* if (sayi==0){
        ...
        System.out.println("canına yandıgım ne gieresen");

        }*/
        //break: bulundugu blogu kırıyor,sonrakilere gitmiyor.
        switch (sayi){
            case 0:
                System.out.println("sıfır");
                break;
            ...
            case 7:
                ...
                break;
            default:
                //default:switch hiçbir case calışmazsa devreye girer.
                System.out.println("canini yiyim ne yazirsen");
                System.out.println("code cıncık oldu DEVAMKEEE");
